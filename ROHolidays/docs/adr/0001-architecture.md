...
- **TanStack Query + AsyncStorage Persister**: folosit pentru fetch + cache + offline fallback; queries stale după 6h, GC după 24h.
...
- Cache-ul AsyncStorage este simplu de inspecționat/șters; dacă schema se schimbă, invalidarea se face prin key versioning.
